...
class Course(models.Model):
    ...
    kcjs_org = models.ForeignKey(Teacher, null=True, blank=True, verbose_name="课程讲师",on_delete=models.CASCADE)
...
class Video(models.Model):
    lesson = models.ForeignKey(Lesson, verbose_name="章节名称",on_delete=models.CASCADE)
